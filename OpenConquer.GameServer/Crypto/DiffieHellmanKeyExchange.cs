...
namespace OpenConquer.GameServer.Crypto
{
    /// <summary>
    /// Conquer‐style Diffie–Hellman server handshake,
    /// builds the “TQServer” key‐exchange packet and derives the shared secret.
    /// </summary>
    public class DiffieHellmanKeyExchange
    {
        ...
        public byte[] CreateServerKeyPacket()
        {
            ...
            // compute total size like Albetros (47 + lens…)
            int fullSize = PadLen
                         + (4   // length field
                            + 4   // junkLen
                            + JunkLen
