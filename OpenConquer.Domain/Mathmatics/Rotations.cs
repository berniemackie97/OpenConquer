...
namespace OpenConquer.Domain.Mathmatics
{
    ...
    public static class Rotations
    {
        ...
        public static uint RotateLeft(this uint value, int count) => (value << count % 32) | (value >> (32 - count % 32));

        /// <summary>Performs a bitwise right rotation.</summary>
        /// <param name="value">Current integer to be rotated</param>
        /// <param name="count">Number of bytes to be shifted by</param>
        /// <returns>Returns the resulting rotation.</returns>
        public static uint RotateRight(this uint value, int count) => (value >> count % 32) | (value << (32 - count % 32));
    }
